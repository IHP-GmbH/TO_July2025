...
T {50fF} 3440 -1000 0 1 0.4 0.4 {}
T {50fF} 3200 -840 0 1 0.4 0.4 {}
N 800 -290 800 -270 {
lab=VSS}
N 800 -530 800 -510 {
lab=VDD}
...
N 1520 -1280 2480 -1280 {lab=#net3}
N 2480 -1280 2480 -840 {lab=#net3}
N 1760 -1120 2000 -1120 {lab=#net5}
N 2000 -1120 2000 -920 {lab=#net5}
N 2000 -920 2090 -920 {lab=#net5}
N 1520 -960 1960 -960 {lab=#net6}
N 1960 -960 1960 -900 {lab=#net6}
N 1960 -900 2090 -900 {lab=#net6}
N 1760 -800 1920 -800 {lab=#net7}
N 1920 -880 1920 -800 {lab=#net7}
N 1920 -880 2090 -880 {lab=#net7}
N 1520 -640 1960 -640 {lab=#net8}
N 1960 -860 1960 -640 {lab=#net8}
N 1960 -860 2090 -860 {lab=#net8}
N 1760 -480 2000 -480 {lab=#net9}
N 2000 -840 2000 -480 {lab=#net9}
N 2000 -840 2090 -840 {lab=#net9}
N 3410 -920 3410 -880 {lab=VDD}
N 3390 -880 3410 -880 {lab=VDD}
N 3360 -850 3360 -840 {lab=VSS}
N 3360 -960 3360 -910 {lab=#net10}
N 3310 -1040 3310 -1000 {lab=VSS}
N 3310 -1040 3330 -1040 {lab=VSS}
N 3360 -1080 3360 -1070 {lab=VDD}
N 3360 -960 3560 -960 {lab=#net10}
N 3360 -1010 3360 -960 {lab=#net10}
N 3170 -760 3170 -720 {lab=VDD}
N 3150 -720 3170 -720 {lab=VDD}
N 3120 -690 3120 -680 {lab=VSS}
N 3120 -800 3120 -750 {lab=#net11}
N 3070 -880 3070 -840 {lab=VSS}
N 3070 -880 3090 -880 {lab=VSS}
N 3120 -920 3120 -910 {lab=VDD}
N 3120 -800 3560 -800 {lab=#net11}
N 3120 -850 3120 -800 {lab=#net11}
N 2710 -900 2800 -900 {lab=#net11}
N 2800 -900 2800 -800 {lab=#net11}
N 2800 -800 3120 -800 {lab=#net11}
N 2710 -920 2800 -920 {lab=#net10}
N 2800 -960 2800 -920 {lab=#net10}
N 2800 -960 3360 -960 {lab=#net10}
...
C {LC_VCO/LC_tank_02.sym} 2160 -880 0 0 {name=x7}
C {LC_VCO/VCO_LC_core.sym} 2640 -880 0 0 {name=x12}
...
C {sg13g2_pr/diodevdd_2kv.sym} 3360 -1040 0 0 {name=D14
model=diodevdd_2kv
m=1
spiceprefix=X
}
C {sg13g2_pr/diodevss_2kv.sym} 3360 -880 0 1 {name=D15
model=diodevss_2kv
spiceprefix=X
m=1
}
C {pwroli.sym} 3360 -840 0 0 {name=l37 lab=VSS}
C {pwroli.sym} 3310 -1000 0 1 {name=l38 lab=VSS}
C {pwroli.sym} 3360 -1080 2 0 {name=l39 lab=VDD
}
C {pwroli.sym} 3410 -920 2 1 {name=l40 lab=VDD
}
...
C {sg13g2_pr/diodevdd_2kv.sym} 3120 -880 0 0 {name=D16
model=diodevdd_2kv
m=1
spiceprefix=X
}
C {sg13g2_pr/diodevss_2kv.sym} 3120 -720 0 1 {name=D17
model=diodevss_2kv
spiceprefix=X
m=1
}
C {pwroli.sym} 3120 -680 0 0 {name=l43 lab=VSS}
C {pwroli.sym} 3070 -840 0 1 {name=l44 lab=VSS}
C {pwroli.sym} 3120 -920 2 0 {name=l45 lab=VDD
}
C {pwroli.sym} 3170 -760 2 1 {name=l46 lab=VDD
}
