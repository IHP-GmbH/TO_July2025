...
## IP Quality assessement schema for an analog design
...
- [ ] Are the IP schematics available at transistor level (analog parts) ?
...
- [ ] Does the IP come with suitable descriptors for integration (e.g. Schematics, GDS, LEF)?
